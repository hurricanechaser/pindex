...
<head>
    ...
    <link href="http://cdn.pinjimu.com/pinjimu_about.css" rel="stylesheet"
        type="text/css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js" type="text/javascript"></script>
    <script src="freshpin.js" type="text/javascript"></script>
    <script src="http://cdn.pinjimu.com/build/files/homeincludes.js"
        ...
        <%--<div class="FixedContainer HeaderContainer">
            ...
            <div id="Search">
                ...
                <a id="query_button" href="#" class="lg">
                    <img src="http://cdn.pinjimu.com/img/search.gif" alt="" /></a>
            </div>
    ...
    <div id="AboutContainer">
        ...
        <div id="AboutContent">
            <div id="AboutLeft">
                ...
                <img src="http://cdn.pinjimu.com/img/NavRule.png" alt="Navigation Rule"
                    id="NavRule" />
                <ul>
