<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="settings.aspx.cs" Inherits="Pinjimu.settings" %>
    ...
    <ul>
        ...
        <li>
            <label>
                <%=strings.Pass %></label>
            <div class="button">
                <a id="changepasswordt" href="javascript:void(0);">
                    <%=strings.Change_Password %></a>
            </div>
        </li>
        <li>
        ...
        <li>
            <label for="speciality">
                Speciality></label>
            <div id="speciality">
                <input name="speciality" value="C" type="checkbox" style="margin: 0px 20px 0px 20px; min-width: 10px;
                    max-width: 50px;" /><img style="padding: 0px; margin: 0px" src="img/prof-Contractor-icon.jpg"
                        style="width: 221px; height: 45px;" alt="Logo" />
                <input name="speciality" value="D"  type="checkbox" style="margin: 0px 20px 0px 20px; min-width: 10px;
                    max-width: 50px;" /><img style="padding: 0px; margin: 0px" src="img/prof-designer-icon.jpg"
                        style="width: 221px; height: 45px;" alt="Logo" />
                <input name="speciality" value="M"  type="checkbox" style="margin: 0px 20px 0px 20px; min-width: 10px;
                    max-width: 50px;" /><img style="padding: 0px; margin: 0px" src="img/prof-FurnManu-icon.jpg"
                        style="width: 221px; height: 45px;" alt="Logo" />
            </div>
        </li>
        <li>
...
<%--Change Password--%>
<div id="changepassword" class="up_chpass" style="width: 700px">
    <h3>
    ...
    <ul>
        <li>
            <label for="pass1">
                <%=strings.Old %></label>
            <div>
                <input type="password" id="pass1" value="xxxxxxxxxx" readonly="readonly" /><span><%=strings.Old_1 %>·
                </span>
            </div>
        </li>
        <li>
    ...
    <div class="button">
        <a id="savechangepassword" href="javascript:void(0)"><span>
            <%=strings.Change_Password %></span></a></div>
</div>
<script type="text/javascript">FreshPin.constants.userSpeciality='<% =o.Speciality %>'</script>
