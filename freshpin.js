...
var FreshPin = {
    constants: {
        ...
        upl: 'http://freshpin.com/cdn/content/uploaded/',
        authcookie: 'auth',
        noblock: false,
        infocookie: 'info',
...
$(function () {
    ...
    if (FreshPin.authenticated()) {
        $('#logininfo').html('<a class="nav" style="padding: 20px 27px 11px 40px;" '
            + String.format('href="{0}#boards"><span class="userProfilePic">', pre)
