<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="settings.aspx.cs" Inherits="Nails.settings" %>
    ...
    <ul>
        ...
        <li>
            ...
            <div class="up_image_div">
                <div>
                    <img src="http://cdn.pinpolish.com/img/load2.gif" alt="Loading..." />
                    <img id="uploadedUserImage" class="up_image_upload" runat="server" src="http://cdn.pinpolish.com/img/userImage.gif"
                        alt="" />
                </div>
...
<%--Change Password--%>
<div id="changepassword" class="up_chpass">
    <h3>
