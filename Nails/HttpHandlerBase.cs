...
namespace Nails
{
    public abstract class HttpHandlerBase : IHttpHandler
    {
        ...
        SubSonic.POCOS.NailsProdDB _GetDataContext3;
        public SubSonic.POCOS.NailsProdDB GetDataContext3
        {
            get
            {
                if (_GetDataContext3 == null) _GetDataContext3 = new SubSonic.POCOS.NailsProdDB();
                return _GetDataContext3;
            }
        }
        SubSonic.POCOS1.NailsProdDB _GetDataContext4;
        public SubSonic.POCOS1.NailsProdDB GetDataContext4
        {
            get
            {
                if (_GetDataContext4 == null) _GetDataContext4 = new SubSonic.POCOS1.NailsProdDB();
