...
namespace PindexProd
{
    public static class Common
    {
        ...
        public static string PindexProdConnectionString
        {
            get
            {
                return WebConfigurationManager.ConnectionStrings["PindexProdConnectionString"].ConnectionString;
            }
        }
        ...
        public static string PindexProdEntities
        {
            get
            {
                return WebConfigurationManager.ConnectionStrings["PindexProdEntities"].ConnectionString;
            }
        }
        ...
        public static class Compiled
        {
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>> BoardImages =
        System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>>
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>> Query =
        System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>>
            ((ctx, p, ps, q) =>
               (from o in ctx.Vw_Images
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>> QueryUser =
       System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>>
           ((ctx, p, ps, userId, q) =>
              (from o in ctx.Vw_Images
               where o.Image_Title.StartsWith(q)
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>> CategoryImages =
           System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>>
               ((ctx, p, ps, name) =>
                   (from o in ctx.Vw_Images
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>> CategoryImagesUser =
    System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>>
        ((ctx, p, ps, userId, name) =>
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int,  IEnumerable<image>> Images =
         System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int,  IEnumerable<image>>
             ((ctx, p, ps) =>
                 (from o in ctx.Vw_Images
                  orderby o.Rating descending
                  select new image
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?,  IEnumerable<image>> ImagesUsers =
     System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?,  IEnumerable<image>>
         ((ctx, p, ps, userId) =>
             (from o in ctx.Vw_Images
              orderby o.Rating descending
              select new image
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>> ImagesinCategories =
          System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, string, IEnumerable<image>>
              ((ctx, p, ps, cats) =>
                  (from o in ctx.Vw_Images
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>> ImagesinCategoriesUsers =
       System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, string, IEnumerable<image>>
           ((ctx, p, ps, userId, cats) =>
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, IEnumerable<image>> Likes =
          System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, IEnumerable<image>>
              ((ctx, p, ps, userId) =>
                  (from o in ctx.Vw_Images
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int, int, int?, IEnumerable<image>> Pins =
         System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int, int, int?, IEnumerable<image>>
             ((ctx, p, ps, userId) =>
                 (from o in ctx.Vw_Images
            ...
            public static System.Func<PindexProd.dbml.PindexProdDataContext, int?, IEnumerable<object>> Boards =
        System.Data.Linq.CompiledQuery.Compile<PindexProd.dbml.PindexProdDataContext, int?, IEnumerable<object>>
            ((ctx, userId) =>
