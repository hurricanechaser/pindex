...
namespace PindexProd
{
    public partial class Pin : PageHandlerBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var imageUrl = (from o in this.GetPindexProdContext2.Vw_Images
                            ...
                            select new
                            {
                                ...
                                cats = (from o1 in this.GetPindexProdContext2.Vw_Cat where o1.ID == o.ID select o1.Name).Distinct().FirstOrDefault(),
            ...
            cat.HRef = string.Format("home.aspx?cat={0}", imageUrl.cats, Request.Url.AbsoluteUri);
